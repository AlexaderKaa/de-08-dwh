...
MERGE INTO dwh.d_product d_product
USING (SELECT DISTINCT product_name, product_description, product_type, product_price from tmp_sources) t
ON d_product.product_name = t.product_name AND d_product.product_description = t.product_description AND d_product.product_price = t.product_price
WHEN MATCHED THEN
